...
function updateDocsHTML(bookmarklets) {
  ...
  const dragLinks = bookmarklets.map(b => {
    if (b.loader) {
      ...
      const loaderCode = `(function(){var s=document.createElement('script');s.src='https://solveitsimply.github.io/clio-bookmarklets/remote/${b.filename.replace(/\.js$/, '')}.js';document.body.appendChild(s);})()`;
  ...
  const codeBlocks = bookmarklets.map(b => {
    if (b.loader) {
      const loaderCode = `javascript:(function(){var s=document.createElement('script');s.src='https://solveitsimply.github.io/clio-bookmarklets/remote/${b.filename.replace(/\.js$/, '')}.js';document.body.appendChild(s);})()`;
      return `
        <h4>${b.name}</h4>
